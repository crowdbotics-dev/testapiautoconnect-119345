...
## Project Structure
    ...
    ├── testapiautoconnect_119345  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_119345`
...
2. Clone this repo and `cd testapiautoconnect_119345`
